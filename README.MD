...
##
* A "powered by phpVMS" is required in page footers, unless the license has been purchased to omit it.
* https://docs.phpvms.net/#license
* A license can be purchased at https://vmshost.io/store/phpvms
##
...
* Will install using MySQL 5.6 and MySQL 5.7 (up to 5.7.4 only).
